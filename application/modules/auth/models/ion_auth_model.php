...
class Ion_auth_model extends MY_Model
{
	...
	**/
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		$query = $this->db->select($this->identity_column . ', username, email, '.$this->tables['users'].'.id, first_name, last_name, password, active, last_login, group_id, '.$this->tables['groups'].'.name, '.$this->tables['groups'].'.description, '.$this->tables['groups'].'.discount')
		                  ->where($this->identity_column, $identity)
