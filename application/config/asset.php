...
|
*/
$config['asset_path'] 		= '_assets/';
$config['css_path'] 		= '_assets/css/';
$config['download_path'] 	= '_assets/download/';
$config['less_path'] 		= '_assets/less/';
$config['js_path'] 			= '_assets/js/';
$config['img_path'] 		= '_assets/images/';
